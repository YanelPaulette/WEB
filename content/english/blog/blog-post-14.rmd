...
El el [Club de R Para RRHH](https://r4hr.club/) nos gusta jugar con datos. Por eso hicimos una encuesta de sueldos, para contar datos actualizados sobre temas relevantes relacionados con nuestra profesión, Recursos Humanos. No vamos a mentir, el objetivo principal es contar con datos con los cuales podamos hacer analisis de datos y desde ya compartir los resultados en forma libre. 

Ectualmente nos encontramos en la etapa de procesamiento  y limpieza de la información. Sin embargo, hasta que la misma este disponible, comparto una serie de resultados, sobre una sección de la Encuesta de Sueldos Kiwi 2021. Espero te guste cómo va quedando! 
