...
categories:
- Aplicación
date: "2022-01-27T11:07:18+06:00"
description: 
draft: false
...
Comparto un segundo adelanto sobre una sección de la Encuesta de Sueldos Kiwi 2021, referida a la vuelta a las oficinas. Espero te guste cómo va quedando! (Si queres ver el primer adelanto, fijate el post sobre Freelance).

Estaremos publicando los resultados finales de la encuesta en  el transcurso de 02/2022
...
A continuación presentamos las respuestas obtenidas en relación a la vuelta al trabajo presencial. 

## Teletrabajo & Presencialidad
...
Muchas gracias por interesarte en nuestra encuesta!! Pronto estaremos subiendo más resultados!!

------------------------------------------------------------------------


¿Querés replicar este código o el resto de las secciones que estamos analizando? Te invito a visitar nuestro repositorio. 
